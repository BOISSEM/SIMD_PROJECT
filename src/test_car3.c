...
void f_test_fd_car3(){
    ...
    sprintf(img0_name, "../car3/car_3000.pgm");
    ...
    {
        sprintf(img0_name, "../car3/car_%d.pgm", 3000+i);
        sprintf(img1_name, "../car3/car_%d.pgm", 3000+i+1);
        ...
        sprintf(img_out_name, "../output/car3_FD_bin/car_%03d.pgm", i);
...
void f_test_sd_car3(){
    ...
    for(i=0; i<NB_IMAGE-1; i++)
    {
        sprintf(img0_name, "../car3/car_%d.pgm", 3000+i+1);
        ...
        sprintf(img_out_name, "../output/car3_SD_bin/car_%03d.pgm", i);
        creation_pgm(img_out_name, img_size_h, img_size_l, maxval, Et);
    }
}
...
void f_test_fd_morpho_car3(){
    ...
    for(i=0; i<NB_IMAGE-1; i++)
    {
        ...
        sprintf(img_out_name, "../output/car3_FD_morpho_bin/car_%03d.pgm", i);
